...
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/style-mobile.css" />
...
<div id="wrap">
	<div id="header">
		<img src="<?php bloginfo("template_url"); ?>/images-mobile/logo.png" id="logo" />
		<div id="menu">
		<a href="/mobile" class="menuButton">Home</a>
		<a href="/mobile-search" class="menuButton">Search</a>
		</div>
		</div>